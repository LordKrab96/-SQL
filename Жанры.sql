...
ALTER TABLE альбом ADD COLUMN год_выпуска varchar(80);

ALTER TABLE сборник ADD COLUMN год_выпуска varchar(80);

ALTER TABLE трек alter column длительность type int USING длительность ::integer;

ALTER TABLE альбом alter column год_выпуска type int USING год_выпуска ::integer;

ALTER TABLE сборник alter column год_выпуска type int USING год_выпуска ::integer;
